        ...
        if (result.output) {
          ...
          let notification = new EmailNotification(
            ...
            [
              ...
              { name: 'Daniel Bossa', email: 'danielbossa@italcol.com' }
            ],
          ...
          if (respNotification.ok)
            resp.message = `La solicitud ${result.output['id']} fue registrada y notificada a los destinatarios`;
